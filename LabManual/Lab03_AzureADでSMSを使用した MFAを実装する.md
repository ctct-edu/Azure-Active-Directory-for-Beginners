...
1. https://entra.microsoft.com/ へアクセスします。
   ...
   > 注:XXXXはご自身のアカウント番号（Skilableで取得したID）を入力してください。
   >
...
2. 画面左ツリーで「Entra ID」→「多要素認証」の順にクリックします。
   ...
   ![module04-03](./media/module04-2.png)
...
4. 別タブが開き「多要素認証」画面が表示されます。設定できる項目を確認し、タブを閉じます。
   ...
   ![module04-03-02](./media/module04-03-02.BMP)
   
   

## タスク2 - MFAの条件付きアクセスのルールを設定する

1. 画面左ツリーで「Entra ID」→「条件付きアクセス」の順にクリックします。

   ![module04-06](./media/module04-06.BMP)

   

3. 「条件付きアクセス | 概要」画面が表示されます。「+新しいポリシーの作成」をクリックします。
...
4. Chris Greenで初めて多要素認証を実施する場合、パスワード認証後に「アカウントをセキュリティで保護しましょう」画面が表示されます。「次へ」をクリックします。
