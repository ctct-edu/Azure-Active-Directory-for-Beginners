...
9. Chris Green として、 https://entra.microsoft.com/ へアクセスします。
...
11. 画面左から「ID」→「ユーザー」→「すべてのユーザー」をクリックし、さらに＋「新しいユーザー」をクリックします。
...
12. 「新しいユーザー」画面が表示されます。次の情報を使用して「作成」をクリックします。
...
13. 「ユーザー」画面に戻ります。画面中央の「更新」をクリックし、作成したユーザーが一覧上に表示されたことを確認します。

    ![module02-20](./media/module02-20.BMP)

    

14. 画面右上のユーザーアイコンをクリックし、「サインアウト」をクリックしてください。
...
5. 「ライセンス割り当ての更新」画面が表示されます。「Microsoft Entra ID P2」チェックを入れ、「保存」をクリックします。
...
14. 「Adam Johnson | ライセンス」画面で、一覧上に「Microsoft Entra ID P2」が表示されたことを確認します。
...
5. 「ライセンス割り当ての更新」画面が表示されます。「Microsoft Entra ID P2」のチェックボックスにチェックを入れ、「保存」をクリックします。
