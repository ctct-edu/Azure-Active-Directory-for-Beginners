...
2. 画面左から「Entra ID」→「ユーザー」→「すべてのユーザー」をクリックし、さらに＋「新しいユーザー」をクリックします。
...
5. 「**新しいユーザー**」 ブレードの「**レビューと作成**」タブで設定した項目を確認し、画面下部にある「**作成**」をクリックします。
...
2. 画面左ツリーの「Entra ID」→「グループ」→「すべてのグループ」の順にクリックします。

   ![module02-07](./media/module02-07.BMP)

   

3. 「グループ」画面が表示されます。画面中央の「新しいグループ」をクリックします。
...
5. 「グループ」画面に戻ります。画面中央の「最新の情報に更新」をクリックし、作成したグループが一覧に表示されたことを確認します。
...
2. 画面左から「Entra ID」→「ユーザー」→「すべてのユーザー」をクリックし、「Chris Green」をクリックします。
...
6. 「アクティブ」を選択し、理由の入力に「ユーザー管理を委任するため」と入力し、「割り当て」をクリックします。
...
12. 画面左から「Entra ID」→「ユーザー」→「すべてのユーザー」をクリックし、さらに＋「新しいユーザー」をクリックします。
...
13. 「新しいユーザー」画面が表示されます。次の情報を使用して作成します。
    ...
    | ユーザープリンシパル名 | 表示名       | 初期パスワード                 | 名   | 姓      | 会社名          | 部署      | 利用場所 |
    | ---------------------- | ------------ | ------------------------------ | ---- | ------- | --------------- | --------- | -------- |
    | AdamJ                  | Adam Johnson | 自由に設定してください。 | Adam | Johnson | Contoso Company | Marketing | 日本     |
...
14. 「ユーザー」画面に戻ります。画面中央の「更新」をクリックし、作成したユーザーが一覧に表示されたことを確認します。
